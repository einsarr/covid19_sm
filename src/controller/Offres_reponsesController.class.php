...
class Offres_reponsesController extends Controller
{
    //private $data;
    ...
    public function view($offre_id)
    {
        $userdb = new UserRepository();
        $reponsesdb = new ReponseRepository();
        $this->data['users'] = $userdb->listeUser($offre_id);
        $this->data['reponses'] = $reponsesdb->getAll($offre_id);
