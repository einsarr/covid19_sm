 ...
 */
class Offre extends \Offre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Offre' . "\0" . 'id', '' . "\0" . 'Offre' . "\0" . 'libelle', '' . "\0" . 'Offre' . "\0" . 'favori', '' . "\0" . 'Offre' . "\0" . 'entreprise', '' . "\0" . 'Offre' . "\0" . 'categorie', '' . "\0" . 'Offre' . "\0" . 'reponses'];
        }
    ...
    public function getFavori()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFavori', []);
    ...
    public function setFavori($favori)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFavori', [$favori]);
