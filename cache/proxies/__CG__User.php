...
class User extends \User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'User' . "\0" . 'id', '' . "\0" . 'User' . "\0" . 'nom_complet', '' . "\0" . 'User' . "\0" . 'email', '' . "\0" . 'User' . "\0" . 'password', '' . "\0" . 'User' . "\0" . 'telephone', '' . "\0" . 'User' . "\0" . 'adresse', '' . "\0" . 'User' . "\0" . 'is_email_confirm', '' . "\0" . 'User' . "\0" . 'profil', '' . "\0" . 'User' . "\0" . 'reponses'];
        }
    ...
    public function getIs_email_confirm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIs_email_confirm', []);

        return parent::getIs_email_confirm();
    }
    ...
    public function setIs_email_confirm($is_email_confirm)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIs_email_confirm', [$is_email_confirm]);

        return parent::setIs_email_confirm($is_email_confirm);
    }
